              ...
              <div className="flex flex-wrap gap-2 max-sm:hidden">
                ...
                <div className="flex items-center lg:order-2">
                  <NavLink to={buttonNames.links.login}>
                    <Button title={buttonNames.name.login} active={true} />
                  </NavLink>
                </div>
                </div>
                ...
                {isMenuOpen && (
                  <div className="absolute top-0 right-0 w-screen h-screen  dark:bg-gray-800 z-50">
                    ...
                    <div className="w-1/2 max-sm:w-full max-md:w-2/3 h-screen bg-white absolute top-0 right-0">
                      <section className="flex flex-wrap sm:hidden gap-2 pt-20 px-6 w-full">
                        <div className="relative w-full">
                          <div className="absolute w-full inset-y-0 left-0 flex items-center pl-3 pointer-events-none transition duration-150 ease-in-out">
                            <svg
                              aria-hidden="true"
                              className={`w-5 h-5 text-gray-500 dark:text-gray-400 trans ${
                                isFocused ? "scale-110	 rotate-90" : ""
                        ...
                        <div className="absolute bottom-5 flex flex-col items-center lg:order-2 w-full ">
                          <NavLink to={buttonNames.links.signUp} className="w-full pr-10">
                            <Button
                          ...
                          <NavLink to={buttonNames.links.login} className="w-full pr-10">
                            <Button
